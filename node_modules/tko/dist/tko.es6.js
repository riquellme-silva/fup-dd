  ...
  */
  ...
  class LifeCycle {
    ...
    computed (params) {
      ...
      } else if (typeof params === 'object') ; else if (typeof params === 'function') {
...
🥊  Knockout warning: components for custom elements must be lowercase and contain a dash.  To ignore this warning, add to the 'config' of .register(componentName, config):
  ...
  function updateChildren (node, children, subscriptions, xmlns) {
    let lastChild$$1 = node.lastChild;
    while (lastChild$$1) {
      removeNode(lastChild$$1);
      lastChild$$1 = node.lastChild;
    }
  ...
  class ComponentBinding extends DescendantBindingHandler {
    ...
    setDomNodesFromJsx (jsx, element) {
      ...
      setDomNodeChildren$1(element, domNodeChildren);
    }
  ...
  class SlotBinding extends DescendantBindingHandler {
    ...
    replaceSlotWithNode (nodeInComponentTemplate, slotNode) {
      ...
      setDomNodeChildren$1(nodeInComponentTemplate, nodesForSlot);
    }
